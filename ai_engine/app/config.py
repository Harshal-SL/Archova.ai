...
def _build_settings() -> Settings:
    ...
    return Settings(
        ...
        rag_embedding_model=os.getenv("RAG_EMBEDDING_MODEL", llm_model),
        rag_collection_name=os.getenv("RAG_COLLECTION_NAME", "system_design_docs"),
        rag_data_root=os.getenv("RAG_DATA_ROOT", str(_PROJECT_ROOT / "data")),
        ...
        rag_retrieval_k=_int_env("RAG_RETRIEVAL_K", 8),
        rag_context_docs=_int_env("RAG_CONTEXT_DOCS", 3),
