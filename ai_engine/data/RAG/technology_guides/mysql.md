...
- Functional requirements for Mysql.
...
2. Choose Mysql only if it improves the target quality attributes.
...
- Use Mysql when relational transactional persistence with consistency, indexing, and backup discipline is a first-order requirement.
...
- Choose Mysql only when it improves the target quality attributes for relational transactional persistence with consistency, indexing, and backup discipline.
