...
- Own the narrow contract for centralized API routing, security enforcement, throttling, and aggregation.
...
- A deployable design for API Gateway.
...
2. Choose API Gateway only if it improves the target quality attributes.
...
- Use API Gateway when centralized API routing, security enforcement, throttling, and aggregation is a first-order requirement.
...
- Provides a disciplined way to implement centralized API routing, security enforcement, throttling, and aggregation.
...
- Managed service that provides a simpler path to centralized API routing, security enforcement, throttling, and aggregation.
...
- Choose API Gateway only when it improves the target quality attributes for centralized API routing, security enforcement, throttling, and aggregation.
