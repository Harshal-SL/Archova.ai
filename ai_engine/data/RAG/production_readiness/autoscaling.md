...
- Own the narrow contract for adjusting capacity automatically to match demand.
...
- Functional requirements for Autoscaling.
...
- A deployable design for Autoscaling.
...
2. Choose Autoscaling only if it improves the target quality attributes.
...
- Use Autoscaling when adjusting capacity automatically to match demand is a first-order requirement.
...
- Provides a disciplined way to implement adjusting capacity automatically to match demand.
...
- Managed service that provides a simpler path to adjusting capacity automatically to match demand.
...
- Choose Autoscaling only when it improves the target quality attributes for adjusting capacity automatically to match demand.
