...
export default function LLDDashboard() {
  ...
  return (
    <div className="flex h-full flex-col bg-white dark:bg-gray-950">
          ...
          {LLD_TABS.map(({ type, label, icon: Icon }) => {
            ...
            return (
              <button
                ...
                className={clsx(
                  "flex flex-col items-start gap-1 rounded-xl border p-2 text-left transition-all",
                  isActive
              ...
              >
                <div className="flex w-full items-center justify-between">
                  <div className="flex items-center gap-1 text-xs font-semibold text-gray-800 dark:text-gray-200">
      ...
      {activeProcess && (
        <div className="flex items-center justify-between border-b border-indigo-500/20 bg-indigo-500/10 px-4 py-2 text-xs">
        ...
        <div className="flex items-center gap-2">
          ...
          {currentData && (
            <button
              ...
              className="flex items-center gap-1 rounded-lg border border-gray-200 bg-white px-2 py-1 text-[11px] font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
            >
        ...
        {currentStatus === "GENERATING" && (
          <div className="flex h-full flex-col items-center justify-center p-6 text-center">
            ...
            <p className="mt-1 max-w-sm text-xs text-gray-500">
              {currentMessage || "Multi-agent engine is designing the low-level modules and schemas."}
            </p>
          </div>
        )}
        ...
        {currentStatus === "READY" && currentData && (
          <>
            {viewMode === "diagram" ? (
              ...
              <div className="h-full overflow-y-auto p-4 font-mono text-xs text-gray-800 dark:text-gray-200">
                <pre className="rounded-xl border border-gray-200 bg-gray-50 p-4 dark:border-gray-800 dark:bg-gray-900">
